#!/usr/bin/env python
"""
Training script for GSPHAR using absolute percentage change data.
This script trains a GSPHAR model on the absolute values of daily percentage changes.
"""
...
from scripts.load_abs_pct_change_data import load_abs_pct_change_data, prepare_data_for_gsphar
...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description='Train a GSPHAR model on absolute percentage change data.')
    ...
    parser.add_argument('--tag', type=str, default='abs_pct_change',
