#!/usr/bin/env python
"""
Script to load and prepare daily percentage change data for GSPHAR model.
This script loads the daily_pct_change_crypto.csv file and prepares it for use with the GSPHAR model.
"""
...
def load_pct_change_data(filepath):
    """
    Load percentage change data from a CSV file.
...
def main():
    ...
    Main function.
    """
    parser = argparse.ArgumentParser(description='Load and prepare daily percentage change data for GSPHAR model.')
