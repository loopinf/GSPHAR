...
def test_dataset_implementations_equivalence():
    """
    Test that LegacyGSPHAR_Dataset and GSPHAR_Dataset produce equivalent results.
    This ensures that the transition to the new implementation doesn't change the model behavior.
    """
...
if __name__ == "__main__":
    test_dataset_implementations_equivalence()
